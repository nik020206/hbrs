Public Class frmMain
    ...
    Private Sub ToolStripButton13_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles toolbarExit.Click
        Dim exit_app As String = MsgBox("Exit application?", vbQuestion + vbYesNo, "Exit")
    ...
    Private Sub ToolStripButton12_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles toolbarLogout.Click
    ...
    Private Sub ToolStripButton10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles toolbarGuest.Click
        frmGuest.ShowDialog()
    End Sub
    ...
    Private Sub toolbarEmployee_Click(sender As Object, e As EventArgs) Handles toolbarEmployee.Click
        frmEmployee.ShowDialog()
    End Sub
